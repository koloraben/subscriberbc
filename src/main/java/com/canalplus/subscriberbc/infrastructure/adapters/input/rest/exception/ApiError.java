...
public class ApiError {
    ...
    private void addValidationError(ObjectError objectError) {
        this.addValidationError(objectError.getObjectName(), ((FieldError) objectError).getField(), ((FieldError) objectError).getRejectedValue(), objectError.getDefaultMessage());
    }
